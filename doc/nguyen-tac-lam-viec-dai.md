...
M��c tiêu KHÔNG phải chỉ tạo một `README.md`.
...
M��i thông tin phải được ưu tiên xác minh từ:
...
M��i command phải được lấy từ project configuration hoặc xác minh thực tế.
...
M��i thay đổi quan trọng nên có:
...
M� tả configuration nhưng KHÔNG ghi secrets.
...
M��i khi có thay đổi quan trọng, file này phải được cập nhật.
...
M��c tiêu là ghi lại những thay đổi ảnh hưởng đến việc AI tiếp quản project.
...
M��i nhóm thông tin phải có trạng thái:
...
M��i file Markdown nên có metadata ở đầu:
...
M��i thông tin quan trọng phải ưu tiên source of truth.
